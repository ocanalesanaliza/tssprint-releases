...
```powershell
git init -b main
git add README.md RELEASE_NOTES_v1.0.8.md PUBLICACION.md .gitignore
...
```powershell
gh release create v1.0.8 ".\release-assets\v1.0.8\Instalar-TSSPrintMaster-1.0.8.exe" ".\release-assets\v1.0.8\TSSPrintMaster-1.0.8-win-x64.zip" ".\release-assets\v1.0.8\tssprint-update.json" ".\release-assets\v1.0.8\SHA256SUMS.txt" --repo "ocanalesanaliza/tssprint-releases" --title "TSSPrintMaster 1.0.8" --notes-file ".\RELEASE_NOTES_v1.0.8.md" --latest
```

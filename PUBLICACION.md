...
```powershell
git init -b main
git add README.md RELEASE_NOTES_v1.0.4.md PUBLICACION.md .gitignore
...
```powershell
gh release create v1.0.4 ".\release-assets\v1.0.4\Instalar-TSSPrintMaster-1.0.4.exe" ".\release-assets\v1.0.4\TSSPrintMaster-1.0.4-win-x64.zip" ".\release-assets\v1.0.4\tssprint-update.json" ".\release-assets\v1.0.4\SHA256SUMS.txt" --repo "ocanalesanaliza/tssprint-releases" --title "TSSPrintMaster 1.0.4" --notes-file ".\RELEASE_NOTES_v1.0.4.md" --latest
```
